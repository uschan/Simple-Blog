...
(function() {
  // 如果已经初始化过，则直接返回
  if (window.reactionsInitialized) {
    return;
  }
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    svgDefs.innerHTML = `
      ...
      <path clip-path="url(#svgid_2_c5)" fill="#795523" d="M42.8,42.2c0,3.4-2.8,6.2-6.2,6.2s-6.2-2.8-6.2-6.2c0-3.4,2.8-6.2,6.2-6.2S42.8,38.8,42.8,42.2"/>
      <path clip-path="url(#svgid_2_c5)" fill="#795523" d="M78.6,42.2c0,3.4-2.8,6.2-6.2,6.2c-3.4,0-6.2-2.8-6.2-6.2c0-3.4,2.8-6.2,6.2-6.2C75.9,36.1,78.6,38.8,78.6,42.2"/>
      <path clip-path="url(#svgid_2_c5)" fill="none" stroke="#795523" stroke-width="4.561" stroke-linecap="round" stroke-linejoin="round" d="M38.8,78.4c0-15,8.3-19.9,16.7-19.9s16.7,4.9,16.7,19.9"/>
      </g>
      </symbol>
      ...
      <path clip-path="url(#svgid_2_c6)" fill="#DD4433" d="M110.8,60.1C99.9,77,79.2,88.4,55.5,88.4c-23.7,0-44.3-11.4-55.2-28.2c0.2,1.9,0.4,3.8,0.8,5.7c0.2,1,0.4,2,0.7,2.9c6.1,24,27.8,41.8,53.8,41.8c26,0,47.7-17.8,53.8-41.8c0.3-1.2,0.6-2.4,0.8-3.6L110.8,60.1z"/>
      ...
      <path clip-path="url(#svgid_2_c6)" fill="#FFFFFF" d="M72.2,58.5H38.8c0,15,8.3,19.9,16.7,19.9S72.2,73.5,72.2,58.5"/>
      <path clip-path="url(#svgid_2_c6)" fill="none" stroke="#7C0A02" stroke-width="4.561" stroke-linecap="round" stroke-linejoin="round" d="M72.2,58.5H38.8c0,15,8.3,19.9,16.7,19.9S72.2,73.5,72.2,58.5z"/>
      <path clip-path="url(#svgid_2_c6)" fill="#621501" d="M31.3,47.5c0,3.1,2.5,5.7,5.7,5.7c3.1,0,6.1-2.5,6.1-5.7c0-3.1-2.9-8.4-6.1-8.4C33.9,39.1,31.3,44.4,31.3,47.5"/>
      <path clip-path="url(#svgid_2_c6)" fill="#621501" d="M79.7,47.5c0,3.1-2.5,5.7-5.7,5.7c-3.1,0-6.1-2.5-6.1-5.7c0-3.1,2.9-8.4,6.1-8.4C77.1,39.1,79.7,44.4,79.7,47.5"/>
      </g>
      </symbol>
      </defs>
      </svg>
  ...
  // 标记为已初始化
  window.reactionsInitialized = true;
})(); 